...
This Instance Painter End User License Agreement ("EULA") is a non-exclusive, legally binding end user license agreement between any individual or a single entity ("END-USER") that acquires a license to Instance Painter by Peter Stefcek ("Licensor").

Please read this End-User License Agreement carefully before downloading, or using Instance Painter ("Application").
...
Some components of the Asset may also be governed by applicable open source software licenses. In the event of a conflict between the applicable EULA and any such open source licenses, the open source software licenses shall prevail with respect to those components.
